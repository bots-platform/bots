...
def create_reportes_by_ticket_by_client(df, word_template_path, word_output_path):
    ...
    reportes_detallados_dict = df_sorted.to_dict(orient="records")

    reporte_detallado_clean_dict = apply_clean_format(reportes_detallados_dict)

    doc = DocxTemplate(word_template_path)
    
    context  = {
        'titulo': f" 01/04/2025 hasta 01/01/2025 ",
        'cliente': "PRONATEL",
        'reportes': reporte_detallado_clean_dict
        }
