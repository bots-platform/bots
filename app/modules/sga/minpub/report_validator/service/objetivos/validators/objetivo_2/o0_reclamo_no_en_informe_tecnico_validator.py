...
@log_exceptions
def o0_reclamo_no_en_cuadro_informe_tecnico_validator(df: pd.DataFrame, componente_word: str) -> pd.DataFrame:
    """
    ...
    df['mensaje'] = f"La incidencia de tipo RECLAMO no se encuentra en informe técnico del Word de {component_type}."
    df['objetivo'] = '2.0.2'
