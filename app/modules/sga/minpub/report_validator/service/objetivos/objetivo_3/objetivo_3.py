...
df_matched_word_telefonia_anexo_indisponibilidad_corte_excel
    ...
    """
    df_validate_anexos_indisponibilidad_word_datos = validate_anexos_indisponibilidad_word(df_matched_word_datos_anexo_indisponibilidad_corte_excel, componente_word = 'COMPONENTE II')
    ...
    df_validate_anexos_indisponibilidad_word_telefonia = validate_anexos_indisponibilidad_word(df_matched_word_telefonia_anexo_indisponibilidad_corte_excel, componente_word = 'COMPONENTE IV')
